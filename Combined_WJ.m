...
while false
   if i <= 9
        ...
        v_mean_w = m_dot_water/(rho_water*(pi*0.036*0.036/4));
    end 
end
...
T_prod_gas_out_PF = T_prod_gas_in - Eff_PF * q_max/C_h;
T_water_out_PF = T_water_in + Eff_PF * q_max / C_c;
...
T_prod_gas_out_CF = T_prod_gas_in - Eff_CF * q_max/ C_h;
T_water_out_CF = T_water_in + Eff_CF * q_max / C_c;
...
Book2.m_dot_condensed_CF(i) = m_dot_liq;
