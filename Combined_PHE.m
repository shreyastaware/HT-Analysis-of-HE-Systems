...
%Book2 = readtable('Book2.xlsx', 'sheet', 'Input_file_PHE');
...
%A_t = 2*no_of_plates*(l_phe_or_plate*h_phe_or_plate);
...
if Pgst2 < Pv2
    ...
    %while false
    %    if PHE_in(i) >= 50
    %        drainage_1 = m_dot_liq*Eff*run_hour(i)*3600*1000/rho_water;
    %    else
...
Book2.m_dot_condensed(i) = m_dot_liq;
Book2.RH_fraction(i) = phi2;
Book2.DinL(i) = drainage + drainage_1;
